...
- **Build OOM (lucide-react):** `npm run build` uses `cross-env NODE_OPTIONS=--max-old-space-size=4096` to give Rollup 4 GB heap when tree-shaking lucide-react's 1000+ icons. Do not remove this flag.
